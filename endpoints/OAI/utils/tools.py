...
from endpoints.OAI.types.tools import ToolCall, Tool, NamedToolChoice
...
class ToolCallProcessor:
    ...
    def from_auto(raw_text: str) -> List[ToolCall]:
        ...
        try:
            ...
            xlogger.debug(f"Auto Parser: Not JSON-in-tool_call ({e}), trying XML")
    ...
    def dump(tool_calls: List[ToolCall]) -> List[dict]:
        ...
        for tool_call_obj in tool_calls:
            try:
                ...
                xlogger.warning(f"Error processing tool call: {e}")
